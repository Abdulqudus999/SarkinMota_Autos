...
const NewsAndAdvices = () => {
  ...
  return (
    <section className='max-w-7xl mx-auto bg-slate-50 py-10'>
      <div className='text-center mb-4'>
        ...
        <p className='font-open-sans text-lg lg:text-xl mt-2'> Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat, molestiae?</p>
      </div>
      <div>
        <Slider {...settings}>
            {
