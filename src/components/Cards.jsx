  ...
  return (
    <div className='group'>
      <div className='border rounded-lg flex flex-col gap-3 items-center justify-center py-10 px-10 bg-red-50 group-hover:bg-red-400 transition-all duration-75 ease-in delay-150'>
        <img src={item.img} alt="" className='w-60 group-hover:scale-125 transition-all'/>
        ...
        <div className='flex justify-between items-center gap-6 pt-2'>
          <p className='font-bold group-hover:text-white delay-150'>{item.price}</p>
          <button className='bg-red-500 text-white px-4 py-2 rounded-md hover:scale-110 transition-all group-hover:bg-white group-hover:text-red-500 delay-150'>Buy Now</button>
        </div>
      </div>
    </div>
  )
